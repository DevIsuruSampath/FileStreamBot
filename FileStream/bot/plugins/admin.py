    ...
    if action in {"info", "help", "docs"}:
        ...
        await m.reply_text(
            text=(
                ...
                f"Banner 300x250 Config: `{'Yes' if bool(getattr(Telegram, 'ADSTERRA_BANNER_300X250_KEY', '') and getattr(Telegram, 'ADSTERRA_BANNER_300X250_INVOKE_URL', '')) else 'No'}`\n"
                f"Banner 728x90 Config: `{'Yes' if bool(getattr(Telegram, 'ADSTERRA_BANNER_728X90_KEY', '') and getattr(Telegram, 'ADSTERRA_BANNER_728X90_INVOKE_URL', '')) else 'No'}`\n"
                f"Banner 320x50 Config: `{'Yes' if bool(getattr(Telegram, 'ADSTERRA_BANNER_320X50_KEY', '') and getattr(Telegram, 'ADSTERRA_BANNER_320X50_INVOKE_URL', '')) else 'No'}`\n"
